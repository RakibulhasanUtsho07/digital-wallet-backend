...
const AuthModule = __importStar(require("./authMiddleware"));
const AdminModule = __importStar(require("./adminMiddleware"));
const AdminAuthorizationModule = __importStar(require("./adminAuthorization"));
function resolveMiddleware(moduleValue, names) {
...
exports.requireAuthentication = resolveMiddleware(AuthModule, [
