...
exports.InputValidationError = exports.DOB_PATTERN = exports.NID_PATTERN = void 0;
exports.parseStrictDate = parseStrictDate;
exports.getAgeOnDate = getAgeOnDate;
exports.requireAdult = requireAdult;
exports.validateAndNormalizeNID = validateAndNormalizeNID;
exports.validateSubmissionIdentity = validateSubmissionIdentity;
exports.NID_PATTERN = /^(?:\d{10}|\d{13}|\d{17})$/;
exports.DOB_PATTERN = /^\d{4}-\d{2}-\d{2}$/;
...
function parseStrictDate(value) {
    if (!exports.DOB_PATTERN.test(value)) {
...
function getAgeOnDate(dateOfBirth, onDate = new Date()) {
...
function requireAdult(dateOfBirth, onDate = new Date()) {
...
function validateAndNormalizeNID(nidInput, dateOfBirth) {
    const nid = nidInput.replace(/[\s-]/g, "");
    if (!exports.NID_PATTERN.test(nid)) {
...
function validateSubmissionIdentity(input, onDate = new Date()) {
