...
exports.decideEKYC = decideEKYC;
const nameSimilarity_js_1 = require("../matching/nameSimilarity.js");
function decideEKYC(input, config) {
    const name = (0, nameSimilarity_js_1.bestNameScore)(input.claimedName, [
    ...
    if (!input.identity.nidMatched)
        return { ...common, status: "REJECTED", reasons: ["NID_MISMATCH"] };
    if (!input.identity.dateOfBirthMatched)
        return { ...common, status: "REJECTED", reasons: ["DOB_MISMATCH"] };
